...
Preloader.prototype.preload = function() {
  ...
  this.game.load.spritesheet('mobs', 'img/RE3___Monster_Sprites_v1_0_by_DoubleLeggy', 32, 32, 12*8);
  this.game.load.spritesheet('npcs', 'img/Visoes_3_Sprites_by_DoubleLeggy', 32, 32, 12*8);
};
